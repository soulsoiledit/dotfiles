  ...
  programs.yazi = {
    ...
    keymap = {
      manager.keymap = [
        ...
        { on = [ "g" "n" ]; exec = "cd /etc/nixos/"; desc = "Go to the config directory"; }
        { on = [ "g" "p" ]; exec = "cd ~/stuff/pictures/"; desc = "Go to the pictures directory"; }
        { on = [ "g" "m" ]; exec = "cd ~/.local/share/PrismLauncher/instances/Main/.minecraft/"; desc = "Go to the MC directory"; }
        { on = [ "g" "t" ]; exec = "cd ~/.local/share/Trash/files"; desc = "Go to the trash directory"; }
        { on = [ "g" "u" ]; exec = "cd /run/media/"; desc = "Go to the USB directory"; }
        { on = [ "g" "v" ]; exec = "cd ~/.config/nvim/"; desc = "Go to the nvim config directory"; }
